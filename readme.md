...
ВСТАВИТЬ СКРИН   
### Шаг 1.4
Подготовим Object Storage. Загрузим датасет из предыдущего задания в формате Parquet по статистике failed-транзакций в бакет
### Шаг 2
Пишем скрипты и помещаем их в бакет. См. файлы `kafka-write.py` и `kafka-read-stream.py`
### Шаг 3
