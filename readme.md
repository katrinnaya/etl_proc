...
### Шаг 4
Запускаем DAG вручную в интерфейсе Airflow. Pyskark-задание отфильтровало failed-транзакции, выполнило аналитику по валютам и сохранило результаты в бакет
